...
![Regional tree canopy, area-weighted across all tracts, 2015–2023.](figures/fig1_region_trend.png){#fig-trend width=80%}
...
![Change in tree canopy by census tract, 2015–2023. Brown bars lost canopy; teal gained.](figures/fig2_change_hist.png){#fig-change width=80%}
...
![Change in tree canopy by census tract, 2015–2023.](figures/map_canopy_change.png){#fig-map width=95%}
...
![Area-weighted canopy change by county, 2015–2023.](figures/fig3_county_change.png){#fig-county width=80%}
...
![Tract-level canopy change against the share of homes built since 2010.](figures/fig4_housing_scatter.png){#fig-housing width=80%}
...
![Baseline canopy by income (left) and average canopy change (right), urban tracts only.](figures/fig5_income_terciles.png){#fig-income width=95%}
